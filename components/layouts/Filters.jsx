    ...
    <aside className="md:w-1/3 lg:w-1/4 px-4">
      ...
      <div className="hidden md:block px-6 py-4 border border-gray-200 bg-white rounded shadow-sm">
        ...
        <div className="grid md:grid-cols-3 gap-x-2">
          ...
          <div className="mb-4">
            <button
              className="px-1 py-2 text-center w-full inline-block text-white bg-teal-600 border border-transparent rounded-md hover:bg-teal-700"
          ...
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Clothing"
                className="h-4 w-4"
                defaultChecked={checkHandler('category', 'Clothing')}
                onClick={(e) => clickHandler(e.target)}
              />
              <span className="ml-2 text-gray-500"> Clothing </span>
            </label>
          </li>
          <li>
            <label className="flex items-center">
              <input
                ...
                value="Accesories"
                className="h-4 w-4"
                defaultChecked={checkHandler('category', 'Accesories')}
                onClick={(e) => clickHandler(e.target)}
              />
              <span className="ml-2 text-gray-500"> Accesories </span>
            </label>
          </li>
        </ul>
